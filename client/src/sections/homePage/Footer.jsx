...
import send from "../../materials/Button/sendButton_Orange.svg";
...
const Footer = (props) => {
  ...
  return (
    <div id="contact" ref={contactRef} >
      <div className="hp-footer-pageStyle" id="footer" ref={footer}>
        <div className="row">
          ...
          {didSuccess ? (
            ...
            <form
              ...
              <input type="hidden" name="redirect" value="http://livewellwithpd.com?success=true" />
